...
import SessionAssignmentsModal from '../features/SessionAssignments/SessionAssignmentsModal';
...
import UserProfileButton from '../features/UserProfilePage/UserProfileButton';
              ...
              <div className="flex-1 overflow-y-auto space-y-6">
                ...
                <div className="bg-white/60 dark:bg-gray-700/60 backdrop-blur-md rounded-lg p-4 shadow-lg border border-white/20 dark:border-gray-600/30">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center px-4 py-3 border border-green-300 dark:border-green-600 text-sm font-medium rounded-md text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors"
                  >
