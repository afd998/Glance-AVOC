  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 py-2 px-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="text-sm text-gray-600 dark:text-gray-300 bg-white/40 dark:bg-white/10 backdrop-blur-sm border border-white/20 dark:border-white/10 shadow-lg rounded-full px-3 py-1">
