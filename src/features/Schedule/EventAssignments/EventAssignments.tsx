...
import { useShifts, Shift } from '../../SessionAssignments/hooks/useShifts';
import { useUpdateShift } from '../../SessionAssignments/hooks/useUpdateShift';
...
const EventAssignments: React.FC<EventAssignmentsProps> = ({
  dates,
  selectedDate,
  onDateSelect,
  className = '',
    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="w-full max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Event Assignments</DialogTitle>
          </DialogHeader>
